...
list = fs.readdirSync(homedir + "/.KartikX/mods");

for (index in list) {
    item = list[index];

    if (!fs.existsSync(homedir + "/.KartikX/mods/" + item + "/kartik.ini") && !fs.existsSync(homedir + "/.KartikX/mods/" + item + "/kartik.yml")) {
        unload(list, item);
...
for (index in list) {
    if (fs.existsSync(homedir + "/.KartikX/mods/" + item + "/kartik.ini")) {
        try {
            moddata[list] = ini.parse(fs.readFileSync(homedir + "/.KartikX/mods/" + item + "/kartik.ini", "utf-8"));
        } catch (e) {
            unload(list, item);
            console.error(e);
            dialog.showMessageBoxSync(
        ...
        try {
            moddata[list] = YAML.parse(fs.readFileSync(homedir + "/.KartikX/mods/" + item + "/kartik.yml", "utf-8"));
        } catch (e) {
            unload(list, item);
            console.error(e);
            dialog.showMessageBoxSync(
...
for (index in list) {
    ...
    for (i4 in hname) {
        ...
        mod["_Path"] = homedir + "/.KartikX/mods/" + item;
