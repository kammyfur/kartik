taglines = [
    ...
    "Hi. I'm KartikX, and I'm a crashaholic.",
    "Ooh. Shiny.",
...
if (native) {
    function crash(error) {
        ...
        report += "    KartikX Version: " + pkg.version + "\n";
        report += "    KartikX Version ID: " + intver + "/official" + "+" + release + "\n";
        ...
        require('fs').copyFileSync(homedir + "/.KartikX/current.kfnx", homedir + "/.KartikX/crashed.kfnx");
        require('fs').writeFileSync(require('os').userInfo().homedir + "/.KartikX/crashes/" + id + ".txt", report);
